...
a = {x=90, y=8, z=23}
for k, v in pairs(a) do if k == 'x' then assert(v == 90) end end
for k, v in pairs(a) do if k == 'a' then assert(false) end end
for k, v in pairs({}) do error('bad') end

for k, v in ipairs({x=10, y=20}) do error('bad') end
local a = {n = 1}
for i, v in ipairs({n=3}) do
