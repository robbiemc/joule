...
int main() {
  ...
  assert(udata != udata2);
  assert(lv_istype(udata, LUSERDATA));
  assert(lv_istype(udata2, LUSERDATA));
  ...
  assert(lv_istype(ltable1, LTABLE));
  assert(lv_istype(ltable2, LTABLE));
